...
public class Rules {
    ...
    public static final String[] colorWan = {"🀇", "🀈", "🀉", "🀊", "🀋", "🀌", "🀍", "🀎", "🀏"};
    public static final String[] colorTiao = {"🀐", "🀑", "🀒", "🀓", "🀔", "🀕", "🀖", "🀗", "🀘"};
    public static final String[] colorTong = {"🀙", "🀚", "🀛", "🀜", "🀝", "🀞", "🀟", "🀠", "🀡"};
    public static final String[] chaWind = {"🀀", "🀁", "🀂", "🀃"};
    public static final String[] chaArrow = {"🀄", "🀅", "🀆"};
    public static final String [] allcards = {"🀀", "🀁", "🀂", "🀃","🀄", "🀅", "🀆","🀇", "🀈", "🀉", "🀊", "🀋", "🀌", "🀍", "🀎", "🀏",
            "🀐", "🀑", "🀒", "🀓", "🀔", "🀕", "🀖", "🀗", "🀘","🀙", "🀚", "🀛", "🀜", "🀝", "🀞", "🀟", "🀠", "🀡"};
    String[] mahjong = {"🀇", "🀈", "🀉", "🀊", "🀋", "🀌", "🀍", "🀎", "🀏","🀙", "🀚", "🀛", "🀜", "🀝", "🀞", "🀟", "🀠", "🀡",
            "🀐", "🀑", "🀒", "🀓", "🀔", "🀕", "🀖", "🀗", "🀘","🀀", "🀁", "🀂", "🀃","🀆","🀅","🀄"};
    /*
    ...
    */
    ...
    public static final String[] alones = {"🀐","🀘","🀇","🀏","🀙","🀡","🀀","🀁","🀂","🀃","🀄","🀅","🀆"};
